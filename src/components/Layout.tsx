...
import { LayoutGrid, Users, MessageSquare, BookOpen, Calendar, MoreHorizontal, Moon, Sun, Bell } from 'lucide-react';
...
export const Layout: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/finance', icon: MoreHorizontal, label: l10n.finance.title.split(' ')[0] },
  ];
        ...
        <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3 pt-safe flex items-center justify-between z-10 shrink-0 transition-colors no-select">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <Link to="/schedule" className="p-2 block hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-smooth">
